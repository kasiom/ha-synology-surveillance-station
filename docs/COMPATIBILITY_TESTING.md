...
Use this checklist when validating the integration on a new Synology model, Surveillance
Station 9.x release, camera vendor, or recording configuration. The integration is read-only.
